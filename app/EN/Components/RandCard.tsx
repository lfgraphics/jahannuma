...
const RandCard: React.FC<{}> = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const formattedRecords = records.map((record: any) => ({
        ...
        fields: {
          ...record.fields,
          ghazal: record.fields?.enBody?.split("\n") || [],
          ghazalHead: record.fields?.enSher?.split("\n") || [],
          shaer: record.fields?.enShaer || "",
  ...
  return (
    <div className="justify-center flex flex-col items-center m-4 h-full">
      <h4
