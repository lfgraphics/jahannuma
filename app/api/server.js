...
const { NEXT_PUBLIC_Client_Id, NEXT_PUBLIC_Client_Secret, PORT = 8888 } = process.env;
...
app.post("/api/orders/:orderID/capture", async (req, res) => {
    console.log("Received POST request at /api/orders/:orderID/capture");
    try {
        // Handle the capture of the order
