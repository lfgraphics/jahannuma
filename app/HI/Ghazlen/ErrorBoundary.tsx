...
class GhazlenErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error("HI Ghazlen Error Boundary caught an error:", error, errorInfo);
  }
...
// Default error fallback component for Hindi
    ...
    <div className="flex flex-col items-center justify-center min-h-[400px] p-8 text-center">
      <div className="max-w-md mx-auto">
        ...
        <p className="text-gray-600 mb-6" dir="rtl">
          ग़ज़लें लोड करने में समस्या हुई है। कृपया दोबारा कोशिश करें।
        </p>
