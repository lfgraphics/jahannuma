...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generatePageMetadata({
    ...
    description:
      "उर्दू साहित्य की समृद्ध दुनिया का अन्वेषण करें। सुंदर शायरी, गज़लें, नज़्में और साहित्यिक कृतियों की खोज करें। क्लासिकल और समकालीन उर्दू कवियों और उनकी उत्कृष्ट कृतियों को जानें।",
...
export default async function Home() {
  ...
  const organizationData = generateOrganizationStructuredData({
    name: "जहाँनुमा",
    description: "उर्दू शायरी और साहित्य की एक व्यापक डिजिटल लाइब्रेरी",
    ...
    "@graph": [
      ...
      // Add FAQ structured data for common questions
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "जहाँनुमा क्या है?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "जहाँनुमा उर्दू शायरी, साहित्य और सांस्कृतिक सामग्री के लिए एक व्यापक डिजिटल प्लेटफॉर्म है जिसमें अशार, गज़लें, नज़्में और ई-बुक्स शामिल हैं।"
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "हाँ, जहाँनुमा पर सभी शायरी और साहित्य सामग्री उर्दू भाषा और संस्कृति को बढ़ावा देने के लिए मुफ्त में उपलब्ध है।"
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "जहाँनुमा में उर्दू शायरी के विभिन्न रूप शामिल हैं जिनमें अशार (दोहे), गज़लें, नज़्में (कविताएं), और रुबाई (चौपाई) क्लासिकल और समकालीन कवियों से हैं।"
            }
          }
        ]
      }
