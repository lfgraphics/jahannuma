...
const Card = ({
  ...
  const takhallus = getLanguageFieldValue(fields, 'takhallus', language, ['HI', 'UR', 'EN']) as string | undefined;
  const name = getLanguageFieldValue(fields, 'name', language, ['HI', 'UR', 'EN']) as string | undefined;
  ...
  return (
    <div className="w-[180px] h-52 rounded overflow-hidden shadow-[#00000080] shadow-md mx-auto my-1 bg-background text-foreground">
      <div className="relative h-full">
        <Link
          href={{ pathname: `/HI/Shaer/${(displayName || "").replace(/\s+/g, "-")}` }}
