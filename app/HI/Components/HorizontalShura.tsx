...
const HorizontalShura = () => {
  ...
  return (
    <div>
      <h2 className="py-4 pb-0 text-center text-4xl">शूरा</h2>
      {loading && <Loader></Loader>}
      {!loading && (
        <div>
          <div
            id="section"
            className="flex flex-row overflow-auto gap-4 py-6 pt-3 px-6 items-center bg-[#F3F4F6] dark:bg-[#2d2d2f]"
          >
            {data.map((item, index) => (
            ...
            <Link className=" text-white text-4xl font-bold" href={"/HI/Shaer"}>
