...
export default function Page() {
  ...
  const visitGhazlen = () => {
    if (typeof window !== "undefined") {
      ...
      if (!referrer.includes("/HI/Ashaar")) {
      ...
      {!effectiveId ? (
        ...
        <div className="p-4 mt-3 w-screen md:w-[400px]">
          ...
          <div className="mazeed flex justify-around" data-aos="fade-up">
            ...
            <Link scroll={false} href={`/HI/Ashaar/shaer/${fields?.shaer?.replace(" ", "_")}`} className="text-blue-600 underline">
              {fields?.shaer} की और कविताएं
            </Link>
          </div>
        </div>
      )}
