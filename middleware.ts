...
const authorizedParties = (process.env.NEXT_PUBLIC_ALLOWED_ORIGINS || "http://localhost:3000,https://localhost:3000,https://www.jahan-numa.org,https://jahan-numa.org,https://jhbeta.vercel.app")
    .split(",")
    .map((s) => s.trim())
    .filter(Boolean);
